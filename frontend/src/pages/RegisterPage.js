            ...
            try {
                ...
                if (err.response) {
                    if (err.response.data.error.message === "EMAIL_EXISTS") {
                        newErrors.custom_error = "Email already registered!";
                    } else if (String(err.response.data.error.message).includes('WEAK_PASSWORD')) {
                        newErrors.custom_error = "Password should be at least 6 characters!";
                    } else {
                        newErrors.custom_error = "An error occurred during registration.";
                    }
                } else {
                    ...
                    <div className="row ">
                        <div className="col register-sec">
                            ...
                            <form onSubmit={handleSubmit} className="register-form" action="">
                                ...
                                <div className="form-group">
                                    <span className="text-danger">{errors.custom_error ? (<p>{errors.custom_error}</p>) : null}</span>
                                    {loading ?
